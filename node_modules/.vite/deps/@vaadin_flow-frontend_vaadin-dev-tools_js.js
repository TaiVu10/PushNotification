import "./chunk-J6LDQ4RS.js";

// node_modules/@vaadin/flow-frontend/vaadin-dev-tools.js
import { css, html, LitElement, nothing } from "lit";
import { property, query, state } from "lit/decorators.js";
import { classMap } from "lit/directives/class-map.js";

// node_modules/@vaadin/flow-frontend/copy-to-clipboard.js
...
// node_modules/@vaadin/flow-frontend/License.js
var noLicenseFallbackTimeout = 1e3;
var findAll = (element, tags) => {
  const lightDom = Array.from(element.querySelectorAll(tags.join(", ")));
  const shadowDom = Array.from(element.querySelectorAll("*")).filter((e) => e.shadowRoot).flatMap((e) => findAll(e.shadowRoot, tags));
  return [...lightDom, ...shadowDom];
};
var licenseCheckListener = false;
var showNoLicenseFallback = (element, productAndMessage) => {
  ...
  const htmlMessage = productAndMessage.messageHtml ? productAndMessage.messageHtml : `${productAndMessage.message} <p>Component: ${productAndMessage.product.name} ${productAndMessage.product.version}</p>`.replace(/https:([^ ]*)/g, "<a href='https:$1'>https:$1</a>");
...
var productTagNames = {};
var productMissingLicense = {};
var overrideCustomElementsDefine = () => {
...
var licenseCheckOk = (data) => {
  console.debug("License check ok for ", data);
};
var licenseCheckFailed = (data) => {
...
(function(ConnectionStatus2) {
  ConnectionStatus2["ACTIVE"] = "active";
  ConnectionStatus2["INACTIVE"] = "inactive";
  ConnectionStatus2["UNAVAILABLE"] = "unavailable";
  ConnectionStatus2["ERROR"] = "error";
})(ConnectionStatus || (ConnectionStatus = {}));
var Connection = class extends Object {
  constructor(url) {
    super();
...
Connection.HEARTBEAT_INTERVAL = 18e4;
var MessageType;
(function(MessageType2) {
  MessageType2["LOG"] = "log";
  MessageType2["INFORMATION"] = "information";
  MessageType2["WARNING"] = "warning";
  MessageType2["ERROR"] = "error";
})(MessageType || (MessageType = {}));
var VaadinDevTools = class extends LitElement {
  constructor() {
    super(...arguments);
    this.expanded = false;
    this.messages = [];
  ...
  openWebSocketConnection() {
    ...
    if (this.backend === VaadinDevTools.SPRING_BOOT_DEVTOOLS && this.springBootLiveReloadPort) {
      ...
      javaConnection = new Connection(void 0);
    }
  ...
  showNotification(type, message, details, link, persistentId) {
    if (persistentId === void 0 || !VaadinDevTools.notificationDismissed(persistentId)) {
      const matchingVisibleNotifications = this.notifications.filter((notification) => notification.persistentId === persistentId).filter((notification) => !notification.deleted);
  ...
  dismissNotification(id) {
    ...
    if (index !== -1 && !this.notifications[index].deleted) {
      ...
      if (notification.dontShowAgain && notification.persistentId && !VaadinDevTools.notificationDismissed(notification.persistentId)) {
  ...
  renderMessage(messageObject) {
    return html`
      <div
        class="message ${messageObject.type} ${messageObject.deleted ? "animate-out" : ""} ${messageObject.details || messageObject.link ? "has-details" : ""}"
      >
        <div class="message-content">
          ...
          <div class="message-details" ?hidden="${!messageObject.details && !messageObject.link}">
            ...
            ${messageObject.link ? html`<a class="ahreflike" href="${messageObject.link}" target="_blank">Learn more</a>` : ""}
          </div>
          ${messageObject.persistentId ? html`<div
        ...
        <dt>
          ...
          <label class="switch">
            <input
              id="toggle"
              type="checkbox"
              ?disabled=${this.liveReloadDisabled || (this.frontendStatus === ConnectionStatus.UNAVAILABLE || this.frontendStatus === ConnectionStatus.ERROR) && (this.javaStatus === ConnectionStatus.UNAVAILABLE || this.javaStatus === ConnectionStatus.ERROR)}
  ...
  copyInfoToClipboard() {
    ...
    const text = Array.from(items).map((message) => (message.localName === "dd" ? ": " : "\n") + message.textContent.trim()).join("").replace(/^\n/, "");
    copy(text);
    this.showNotification(MessageType.INFORMATION, "Environment information copied to clipboard", void 0, void 0, "versionInfoCopied");
  }
  toggleFeatureFlag(e, feature) {
    const enabled = e.target.checked;
    if (this.frontendConnection) {
      this.frontendConnection.setFeature(feature.id, enabled);
      this.showNotification(MessageType.INFORMATION, `\u201C${feature.title}\u201D ${enabled ? "enabled" : "disabled"}`, feature.requiresServerRestart ? "This feature requires a server restart" : void 0, void 0, `feature${feature.id}${enabled ? "Enabled" : "Disabled"}`);
    } else {
...
VaadinDevTools.MAX_LOG_ROWS = 1e3;
...
VaadinDevTools.AUTO_DEMOTE_NOTIFICATION_DELAY = 5e3;
...
if (customElements.get("vaadin-dev-tools") === void 0) {
...
//# sourceMappingURL=@vaadin_flow-frontend_vaadin-dev-tools_js.js.map
