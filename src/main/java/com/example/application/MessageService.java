...
public class MessageService {
    @Value("${BE88dPhMowoKSvGQPTX18_VECHNujXzTL8o7vVfhlIkBzQD96pn6VjpykFNSyopl2XGovUylOENfSEDAcWErLNY}")
    private String publicKey;
    @Value("${Hyr_QeVq1TZ_M4xvCGYdGv_Svkf7soagGvIeHtGTPO0}")
    ...
    private void sendNotifications() {
        ...
        subscriptions.forEach(subscription -> {
            sendNotification(subscription, String.format(text,LocalTime.now()));
        });
    }
