...
import stylesCss from 'themes/push-notification/styles.css?inline';
...
export const applyTheme = (target) => {
  ...
  if (!document['_vaadintheme_push-notification_componentCss']) {
    
    document['_vaadintheme_push-notification_componentCss'] = true;
  }
